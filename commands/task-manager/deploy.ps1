# Task Manager Microservice Deployment Script (PowerShell)
...
Write-Host "=== Task Manager Deployment ===" -ForegroundColor Cyan
...
Write-Host "Deploying Task Manager API..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "Task Manager API URL: $API_URL" -ForegroundColor Cyan
Write-Host ""
Write-Host "See deploy.sh for API usage examples"
Write-Host ""
